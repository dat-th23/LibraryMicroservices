    ...
    CommandLineRunner initData(UserService userService, UserRepository userRepository) {
        return args -> {
            ...
            if (listUserExisted.isEmpty()) {
                userService.saveUser(new User("Đặng Trần Huy", "admin", "admin123", "0868304902", "dangtranhuy1104@gmail.com", "1.png", "Hà Nội",
...
//                        User.AccountStatus.ACTIVE, 500000, new ArrayList<>()));
                ...
                userService.addRoleToUser("dangtranhuy1104@gmail.com", "ADMIN");
